...
tags: ['SQLServer', 'Database', 'DateTime']
draft: false
layout: PostLayout
...
<table aria-label="参数" class="table-sm table">
  <thead>
    <tr>
      <th>
        <em>datepart</em>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <strong>ISO_WEEK</strong>
      </td>
      <td>
        <strong>ISOWK, ISOWW</strong>
      </td>
    </tr>
  </tbody>
</table>
